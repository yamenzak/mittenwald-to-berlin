...
export const PLACES = {
  ...
  leipzig:      { n: "Leipzig",         q: "Leipzig Hauptbahnhof",               w: "Leipzig",                       stn: "Leipzig Hauptbahnhof",          country: "DE" },
...
export const SIGHTS = {
  ...
  wurzburg: [
    S("Würzburg Residence", "Würzburger Residenz", "UNESCO. Tiepolo's staircase fresco is the largest in the world.", { must: 1, at: [49.79290, 9.93930], mins: 85, kind: "palace", indoor: 1, ticket: 1 }),
    S("Old Main Bridge", "Alte Mainbrücke", "Stone saints along the parapet. People drink wine on it at sunset.", { must: 1, mins: 40, kind: "sight" }),
    ...
    S("Court Garden", "Würzburger Residenz", "Behind the Residence, free to walk into.", { at: [49.79210, 9.94080], cimg: "Hofgarten Würzburg", mins: 20, kind: "nature" }),
    S("Neumünster", "Neumünster (Würzburg)", "Round red-and-white baroque front beside the cathedral, over the grave of St Kilian.", { mins: 25, kind: "church", indoor: 1 }),
    S("Juliusspital", "Juliusspital", "A hospital that owns vineyards and has done since 1576. The courtyard and the wine bar are open to anyone.", { mins: 45, kind: "food" }),
    S("Käppele", "Käppele", "Pilgrimage chapel above the vineyards, up 247 steps past the Stations of the Cross.", { mins: 75, kind: "view" }),
  ...
  erfurt: [
    S("Anger", "Anger (Erfurt)", "The wide shopping street between the station and the old town.", { mins: 20, kind: "street" }),
    S("Merchants' Bridge shops", "Krämerbrücke", "Thirty-two houses on the bridge, with workshops in the ground floors.", { cimg: "Krämerbrücke Erfurt Geschäfte", mins: 25, kind: "shop" }),
    ...
    S("Krämerbrücke", "Krämerbrücke", "A bridge with houses on it, lived in continuously since 1325.", { must: 1, mins: 30, kind: "street" }),
    S("Domplatz", "Domplatz (Erfurt)", "Cathedral and St Severi side by side above a huge open square.", { must: 1, mins: 20, kind: "square" }),
    ...
    S("Fischmarkt", "Fischmarkt (Erfurt)", "Renaissance houses and the town hall. Dinner here.", { must: 1, mins: 25, kind: "square" }),
  ...
  weimar: [
    ...
    S("Goethe's House", "Goethes Wohnhaus", "On Frauenplan. He lived here for fifty years; it is exactly as he left it.", { must: 1, mins: 60, kind: "museum", indoor: 1, ticket: 1, closed: [1] }),
  ...
  naumburg: [
    ...
    S("Marktplatz", "Naumburg (Saale)", "Late-Gothic town hall and burgher houses.", { must: 1, mins: 20, kind: "square" }),
    ...
    S("Salztor and the Saale", "Naumburg (Saale)", "The old salt gate at the bottom of the town, and the river path below it.", { at: [51.14790, 11.80280], cimg: "Salztor Naumburg", mins: 25, kind: "street" }),
    S("Marienstraße", "Marienstraße (Naumburg)", "The old street between the market and the Marientor, timber-framed most of the way.", { at: [51.15230, 11.80830], mins: 25, kind: "street" }),
    S("The historic tram", "Naumburger Straßenbahn", "One line, one carriage, running since 1892. It goes from the Hbf to the cathedral.", { at: [51.15380, 11.79920], mins: 20, kind: "sight", ticket: 1 }),
    S("Saale-Unstrut wine", "Saale-Unstrut (Weinanbaugebiet)", "The northernmost quality wine region in Europe. The taverns round the market pour it by the glass.", { at: [51.15060, 11.80900], mins: 45, kind: "food" }),
  ],
  quedlinburg: [
  ...
  halle: [
    S("Marktplatz and the Red Tower", "Roter Turm (Halle)", "Five towers over one square — four on the church, one standing alone.", { must: 1, mins: 25, kind: "square" }),
    S("Market Church", "Marktkirche Unser Lieben Frauen", "Luther preached here; his death mask is upstairs.", { mins: 25, kind: "church", indoor: 1 }),
    ...
    S("Halle Cathedral", "Hallescher Dom", "Plain outside, and the oldest church in the city. Handel played the organ here.", { at: [51.48320, 11.96530], mins: 25, kind: "church", indoor: 1 }),
    S("The Nebra Sky Disc", "Landesmuseum für Vorgeschichte (Halle)", "The oldest known map of the stars, 3600 years old, in the prehistory museum.", { at: [51.49150, 11.97340], cimg: "Himmelsscheibe von Nebra", must: 1, mins: 75, kind: "museum", indoor: 1, ticket: 1, closed: [1] }),
    S("Francke Foundations", "Franckesche Stiftungen", "A whole school town from 1698, with a cabinet of curiosities still in its original cases.", { at: [51.47810, 11.97230], mins: 60, kind: "museum", indoor: 1, ticket: 1 }),
  ...
  leipzig: [
    S("Hauptbahnhof", "Leipzig Hauptbahnhof", "The largest railway terminus in Europe by floor area, and a shopping street on two levels inside it.", { mins: 25, kind: "sight", indoor: 1 }),
    S("Marktplatz and the Old Town Hall", "Altes Rathaus (Leipzig)", "One of the last great Renaissance town halls in Germany, the whole length of the square.", { must: 1, mins: 40, kind: "square" }),
    S("Mädler Passage", "Mädlerpassage", "Glass-roofed arcade with Auerbachs Keller under it — the cellar Goethe put in Faust.", { must: 1, mins: 40, kind: "shop", indoor: 1 }),
    S("St Thomas Church", "Thomaskirche", "Bach was cantor here for 27 years and is buried in front of the altar. The boys' choir still sings.", { must: 1, mins: 45, kind: "church", indoor: 1 }),
    S("Bach Museum", "Bach-Museum Leipzig", "Across the square from the church, in the house of the family he worked for.", { mins: 60, kind: "museum", indoor: 1, ticket: 1, closed: [1] }),
    S("Nikolaikirche", "Nikolaikirche (Leipzig)", "The Monday prayers here turned into the demonstrations that brought the Wall down.", { must: 1, mins: 30, kind: "church", indoor: 1 }),
    S("Augustusplatz", "Augustusplatz", "The opera at one end, the Gewandhaus at the other, and the university tower above.", { mins: 30, kind: "square" }),
    S("Leipzig coffee", "Zum Arabischen Coffe Baum", "One of the oldest coffee houses in Europe, pouring since 1711.", { mins: 45, kind: "food", indoor: 1 }),
  ],
  magdeburg: [
    ...
    paths: [
      { id: "A", name: "Heidelberg, Würzburg, Bamberg", why: "Three towns and the longest ride of the week, which is what the west costs.", seq: [
        { S: "heidelberg", arr: "08:00", dep: "11:55", stn: "Bus 33 to the castle, or the funicular from Kornmarkt. The Philosophers' Walk is over the Old Bridge.",
          see: ["Heidelberg Castle", "The Great Tun", "German Pharmacy Museum",
                "University Square", "Student Prison", "Jesuitenkirche",
                "Old Bridge", "Philosophers' Walk", "Königstuhl funicular"] },
        ...
        { S: "wurzburg", arr: "14:20", dep: "16:40", stn: "Ten minutes down Kaiserstraße from the Hbf, or tram 1 to Dom.",
          see: ["Würzburg Residence", "Court Garden", "Neumünster", "Würzburg Cathedral",
                "Marktplatz and Marienkapelle", "Juliusspital", "Old Main Bridge",
                "Franconian wine", "Marienberg Fortress"] },
        ...
        { S: "bamberg", arr: "17:35", dep: "18:45", stn: "Twenty minutes from the station to the river, or bus 901.",
          see: ["Obere Brücke", "Old Town Hall", "Little Venice", "Schlenkerla",
                "Bamberg Cathedral", "Alte Hofhaltung", "New Residence rose garden",
                "Böttingerhaus", "Maximiliansplatz"] },
        ...
        { S: "erfurt", arr: "19:55", base: 1, stn: "Fifteen minutes from the station up the Anger to the old town, or tram 3, 4 or 6.",
          see: ["Anger", "Fischmarkt", "Krämerbrücke", "Merchants' Bridge shops", "Domplatz"] },
      ]},
    ],
  },
  {
    ...
    intro: "Four stops down the Saale before the last long ride: Goethe's town, a cathedral, Handel's birthplace, and Bach's.",
    paths: [
      { id: "A", name: "Weimar, Naumburg, Halle, Leipzig", why: "Four towns before the one long ride into Berlin.", seq: [
        { S: "erfurt", arr: "07:15", dep: "09:30", stn: "Fifteen minutes from the station up the Anger, or tram 3, 4 or 6 to Domplatz.",
          see: ["Anger", "Fischmarkt", "Krämerbrücke", "Merchants' Bridge shops", "Ägidienkirche tower",
                "Domplatz", "Erfurt Cathedral", "St Severi", "Augustinian Monastery"] },
        ...
        { S: "weimar", arr: "09:52", dep: "12:00", stn: "Fifteen minutes downhill from the station into the centre.",
          see: ["Marktplatz", "Cranach House", "Theaterplatz", "Goethe's House", "Schiller's House",
                "Wittumspalais", "Duchess Anna Amalia Library"] },
        T("12:00", "12:42", "Naumburg", ["weimar", "naumburg"]),
        { S: "naumburg", arr: "12:42", dep: "13:40", stn: "Fifteen minutes from the Hbf, or the little historic tram, to the old town.",
          see: ["The historic tram", "Naumburg Cathedral", "Marktplatz", "Marienstraße", "St Wenceslas",
                "Town walls and Marientor", "Saale-Unstrut wine"] },
        T("13:40", "14:19", "Halle", ["naumburg", "halle"]),
        { S: "halle", arr: "14:19", dep: "15:40", stn: "Ten minutes from the Hbf up Leipziger Straße to the market, or any tram.",
          see: ["Marktplatz and the Red Tower", "Market Church", "Händel House", "Halle Cathedral",
                "Moritzburg", "The Nebra Sky Disc", "Francke Foundations"] },
        T("15:40", "16:09", "Leipzig", ["halle", "leipzig"], "Half an hour on the S-Bahn."),
        { S: "leipzig", arr: "16:09", dep: "18:40", stn: "Out through the station hall — it is worth a look on the way — and the market is ten minutes straight ahead.",
          see: ["Hauptbahnhof", "Marktplatz and the Old Town Hall", "Mädler Passage", "St Thomas Church",
                "Bach Museum", "Nikolaikirche", "Augustusplatz", "Leipzig coffee"] },
        T("18:40", "21:44", "Berlin", ["leipzig", "berlin"], "The long one, three hours. Buy something to eat before you board."),
        { S: "berlin", arr: "21:44", base: 1, stn: "You have arrived. Berlin Hauptbahnhof.",
